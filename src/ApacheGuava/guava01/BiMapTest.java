...
/**
 * BiMap (双向映射)，是一种保持其值和键的唯一性的映射，此约束使 BiMap 支持 "反向视图"，
...
public class BiMapTest {
     ...
     *      (1) putAll中存在 同Key、同value 时会抛出异常java.lang.IllegalArgumentException: value already present:
     */
    @Test
